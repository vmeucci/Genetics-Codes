...
if __name__ == '__main__':
    ...
    objAlgoritmoGenetico.melhor_individuo(objAlgoritmoGenetico.populacao[0])
    ...
    print("Fitness total da populacao: %s\n" % objAlgoritmoGenetico.soma_avaliacoes())

    print("Solução %s\n" % objAlgoritmoGenetico.melhor_solucao.cromossomo,
          "Fitness %s\n" % objAlgoritmoGenetico.melhor_solucao.fitness)
